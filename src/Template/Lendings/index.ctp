    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('set_loan_user_id') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $lending->has('book') ? $this->Html->link($lending->book->name, ['controller' => 'Books', 'action' => 'view', $lending->book->id]) : '' ?></td>
                <td><?= $lending->has('user') ? $this->Html->link($lending->user->name, ['controller' => 'Users', 'action' => 'view', $lending->user->id]) : '' ?></td>
                <td><?= $this->Number->format($lending->set_loan_user_id) ?></td>
