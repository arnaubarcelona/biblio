...
<div class="conservationStates view large-9 medium-8 columns content">
    ...
    <div class="related">
        ...
        <?php if (!empty($conservationState->books)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($conservationState->books as $books): ?>
            <tr>
                <td><?= h($books->id) ?></td>
                <td><?= h($books->name) ?></td>
                <td><?= h($books->isbn) ?></td>
    ...
    <div class="related">
        ...
        <?php if (!empty($conservationState->items)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
            ...
            <?php foreach ($conservationState->items as $items): ?>
            <tr>
                <td><?= h($items->id) ?></td>
