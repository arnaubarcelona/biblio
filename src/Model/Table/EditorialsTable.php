 ...
 * @method \App\Model\Entity\Editorial newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Editorial[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Editorial|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Editorial patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\Editorial[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\Editorial findOrCreate($search, callable $callback = null, $options = [])
 *
 * @mixin \Cake\ORM\Behavior\TimestampBehavior
 */
class EditorialsTable extends Table
{
